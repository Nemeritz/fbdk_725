...
import fb.rt.*;
import fb.rt.events.*;
/** FUNCTION_BLOCK Conveyor_4_7_CTL
  * @author JHC
  * @version 20181017/JHC
  */
public class Conveyor_4_7_CTL extends FBInstance
{
...
* @throws FBRManagementException {@inheritDoc} */
  public void connectIV(String ivName, ANY newIV)
    ...
    else if("Grant".equals(ivName)) connect_Grant((BOOL)newIV);
...
/** Connect the given variable to the input variable Grant
  * @param newIV The variable to connect
 */
  public void connect_Grant(BOOL newIV){
    Grant = newIV;
    }
