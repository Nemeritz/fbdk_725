...
/** FUNCTION_BLOCK Delay
  ...
  */
public class Delay extends FBInstance
{
...
/** Services the REQ event. */
  public void service_REQ(){
    if ((eccState == index_DELAY)) state_REQ();
    else if ((eccState == index_START) && (QI.value)) state_DELAY();
    else if ((eccState == index_DELAYBACK)) state_START();
